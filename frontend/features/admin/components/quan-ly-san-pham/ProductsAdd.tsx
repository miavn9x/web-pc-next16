            ...
            <div className="p-4 sm:p-6 space-y-4" id="section-basic-info">
              ...
              <div id="group-name-vi">
                ...
                <input
                  ...
                  placeholder={
                    currentLang === "vi" ? "Nhập tên sản phẩm" : "商品名を入力"
                  }
